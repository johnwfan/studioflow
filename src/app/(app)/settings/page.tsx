      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-10 sm:px-8 lg:px-10">
        ...
        <section className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-600">
            These settings are intentionally lightweight for MVP. They show
            where personal workspace controls will live as Studioflow grows.
          </p>

          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <article className="rounded-2xl border border-zinc-200 bg-zinc-50 p-5">
              <p className="text-sm font-medium text-zinc-900">Theme</p>
              <p className="mt-2 text-sm leading-6 text-zinc-600">
                Coming soon. Light and dark appearance options will live here.
              </p>
            </article>
